                      ...
                      {menuOpen === b.id && (
                        <div className="bk-dots-menu" onMouseDown={e => e.stopPropagation()}>
                          ...
                          {['Quotation', 'Confirmed', 'Completed', 'Cancelled'].filter(s => s !== (b.booking_status || 'Quotation')).map(s => (
                            ...
                            >
                              {s === 'Quotation' && (
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{marginRight:6,flexShrink:0}}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                              )}
                              {s === 'Confirmed' && (
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{marginRight:6,flexShrink:0,color:'#2e7d32'}}><polyline points="20 6 9 17 4 12"/></svg>
                              )}
                              {s === 'Completed' && (
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{marginRight:6,flexShrink:0,color:'#1565c0'}}><polyline points="20 6 9 17 4 12"/><polyline points="20 12 9 23 4 18"/></svg>
                              )}
                              {s === 'Cancelled' && (
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{marginRight:6,flexShrink:0,color:'#c62828'}}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                              )}
                              {s}
                            </button>
                          ))}
